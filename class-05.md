...
JPEG - Best for saving photographs

GIF - Best of illustraitions or logos that use flat colors
...
### Animated GIFs - show several frames of an image in sequence. Each extra frame of an image increases the size of the fle and the time for the image to download.

### Transparency - creating an image that is partially transparent from the web involves selecting on of two formats:
